...
if len(sys.argv) > 2:
    ...
    locy = 1
if len(sys.argv) > 3:
    sizx = int(sys.argv[3]) - locx
else:
    sizx = 50
if len(sys.argv) > 4:
    sizy = int(sys.argv[4]) - locy
else:
    sizy = 50
...
print("It accepts commandline args.. x1 y1 x2 y2")
print("eg python screen_util.py 10 20 30 40")
print("eg python screen_util.py 10 10")
print("Use Arrow keys to move the area around... Keypad 2, 4, 6, 8 to widen area")
print("/ and * to change background color from black to white")
print(" Keypad + - to change zoom")
    ...
    while running:
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_s:
                    cimg = img.crop((locx, locy, locx + sizx, locy + sizy))
                    cimg.save("screenshots/save.png")
